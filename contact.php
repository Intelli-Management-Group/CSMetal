    ...
    <head>
        ...
        <style>
            ...
            .upparCasetextTransformed::after {
                ...
                background: #005399; /* Set underline color */
            ...
            .elementor-field-group {
                ...
                padding: 20px; /* Optional: padding around each field */
            }
            ...
            .elementor-button:hover {
                background-color: #005399; /* Darker shade on hover */
            }
        </style>
