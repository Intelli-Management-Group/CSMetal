        ...
        <div class="row pt-3">
            ...
            <div class="col-sm-12 col-md-4 scroll2moveup">
                <div class="product-wrap">
                    ...
                    <h5 class="mt-3"> Dsaw Pipe </h5>
                    <p>At Fabrik, we stand out as the sole American mill that provides small lot deliveries while utilizing the proven U-O-E production technology, ensuring superior field performance</p>
                </div>
            </div>
            <div class="col-sm-12 col-md-4">
                <div class="product-wrap">
                    ...
                    <h5 class="mt-3">Hot Rolled Coil</h5>
                    <p>We take pride in ensuring reliable and efficient supply chains to meet the specific needs of our valued customers across various sectors.</p>
                </div>
            </div>
        </div>
