            ...
            <div class="row section-padding">
                ...
                <div class="col-sm-12 col-md-4 pb-0">
                    <div class="product-wrap">
                        ...
                        <p class="mb-0">CS Metal’s testing solutions ensure reliability. The Metal Hardness Measurement Machine offers precise hardness testing for validation. The Push-Pull Force Test evaluates connection strength over 1500 lbs. The Transportation Compression Test simulates transit conditions, while the Transportation Vibration Test assesses resilience against vibrations.</p>
                    </div>
                </div>
            </div>
        </div>
